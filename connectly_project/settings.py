...
SECRET_KEY = 'django-insecure-9wd=t1mg+v3em39#ek03)ro%w75=(u4jojhc=s2o#b%i53reiv'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60), #change this a lower value in production
